...
const styles = StyleSheet.create({
  ...
  section: {
    ...
    borderWidth: 1,
    borderColor: '#e5e7eb',
    // overflow: 'hidden', // CAUSE DU FREEZE SUR CONTENU LONG
...
const UserPDFDocument: React.FC<UserPDFDocumentProps> = ({ user, gestionnairesList }) => {
  ...
  // Utilisation directe de formatDate importée
        ...
        {user.hasPrevExp && (
          <View style={styles.section}>
            ...
            <View style={styles.sectionContent}>
              ...
              {/* Conclusion - Solution de relogement */}
