                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {isAiAvailable && formData.logementDetails.descriptionLitige && formData.logementDetails.descriptionLitige.trim() && (
                        <LisserButton
                          text={formData.logementDetails.descriptionLitige}
                  ...
                  <div className="col-span-2">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {isAiAvailable && formData.logementDetails.actionsPrises && formData.logementDetails.actionsPrises.trim() && (
                        <LisserButton
                          text={formData.logementDetails.actionsPrises}
          ...
          <div className="bg-gradient-to-r from-slate-50 to-gray-50 p-4 rounded-lg border border-slate-200 mb-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                {isAiAvailable && formData.logementDetails.commentaire && formData.logementDetails.commentaire.trim() && (
                  <LisserButton
                    text={formData.logementDetails.commentaire}
