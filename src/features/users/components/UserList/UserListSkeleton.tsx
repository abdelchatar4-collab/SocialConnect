...
export const UserListSkeleton: React.FC<{ isAdmin: boolean; viewMode: 'table' | 'grid' }> = ({ isAdmin, viewMode }) => (
    <div className="space-y-6">
        <UserListHeader users={[]} title="Liste des usagers" subtitle="Chargement..." isAdmin={isAdmin} loading={true} onRefresh={() => { }} onExport={() => { }} onBulkDelete={() => Promise.resolve()} onDeleteAll={() => Promise.resolve()} selectedCount={0} />
