  ...
  const handleDevLogin = async (email?: string) => {
    try {
      ...
      if (result?.ok) {
        ...
        console.error('Erreur de connexion dev:', result?.error)
      ...
      <div className="max-w-md w-full space-y-8 p-8">
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gray-50 text-gray-500">OU (dev only)</span>
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            Vos emails autorisés doivent être dans la table <code className="bg-gray-100 px-1 rounded">gestionnaires</code>
          </p>
        </div>
      </div>
    </div>
