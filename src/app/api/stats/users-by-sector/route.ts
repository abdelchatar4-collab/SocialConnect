...
import { processUserSector } from '@/services/stats/sectorMappingService';

export const dynamic = 'force-dynamic';

/**
 * GET - Returns user statistics grouped by geographical sector
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Calculate the sector for each user
