...
const optionsToSeed = {
    ...
    prevExpNegociationProprio: [
        'Plan d\'apurement accepté',
        'Plan d\'apurement refusé',
        'Aucun plan d\'apurement'
    ],
    prevExpSolutionRelogement: [
        'Logement identique',
        'Logement privé ext. de Bxl',
        'Logement privé Bxl',
        'Logement public Bxl',
        'Logement public ext. Bxl',
        'Logement de transit',
        'Logement d\'urgence',
        'SAMU Social',
...
async function main() {
    console.log('Start seeding PrevExp options...');
